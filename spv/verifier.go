...
// VerifyProofs will make the verifier validate the ancestor merkle proofs for each parent transaction.
...
// NoVerifyProofs will switch off ancestor proof verification
...
// - ancestor verification (proofs checked etc)
